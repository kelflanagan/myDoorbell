ruleset b501118x0 {
  meta {
    ...
    provides myDoorbellRingtone myDoorbellRingtoneChunk, myDoorbellConfig
...
// https://cs.kobj.net/sky/cloud/b502118x0/fn?_eci=C695CE4E-0B91-11E3-9DB3-90EBE71C24E1
    ...
    //                 }
    //
    // Example curl: curl https://cs.kobj.net/sky/cloud/b502118x0/myDoorbellConfig?_eci=
    //							C695CE4E-0B91-11E3-9DB3-90EBE71C24E1
    //
    ...
    //
    // Example curl: curl http://cs.kobj.net/sky/cloud/b502118x0/myDoorbellRingtone?door=front&
...
//			       meta:eci();
      ringtoneResourceFront = '/sky/cloud/' + 
      			       meta:rid() + 
			       '/myDoorbellRingtone?door=front&_eci=' +
			       meta:eci();

      ringtoneResourceRear = '/sky/cloud/' + 
      			       meta:rid() + 
			       '/myDoorbellRingtone?door=rear&_eci=' +
			       meta:eci();
